...
from app.modules.stock.stock_resource import StockResource
from app.modules.stock_type.stock_type_resource import StockTypeResource
...
# STOCK
api.add_resource(StockResource, '/estoque', '/estoque/<string:action>')
